...
def test(net, testloader, device, out_features):
    ...
    print("New dataset's Test Acc = ", correct / total)
    # Save checkpoint.
    acc = correct / total
...
def train(net, old_net, epoch, trainloader, out_features, device, optimizer, T, criterion, alpha):
    ...
    for data in tqdm(trainloader, desc="train", mininterval=1):
        ...
        if step % 100 == 0:
            print(correct / total)
    print("New dataset's Train Acc = ", correct / total)
...
def main(node_list, edge_list):
    ...
    parser.add_argument('--batch-size', type=int, default=64, help='batch size, (default: 100)')
    ...
    graph_matrix = {0: [], 1: [0], 2: [0], 3: [1], 4: [3], 5: [0], 6: [1, 4], 7: [3], 8: [0], 9: [0], 10: [8], 11: [0],
                    12: [6, 10], 13: [4, 11, 12], 14: [2, 7, 8, 12], 15: [2, 9, 14], 16: [13], 17: [15, 16],
                    18: [9, 16, 17],
                    19: [17], 20: [5, 8, 9], 21: [18, 19], 22: [10, 15, 18, 21], 23: [5, 8, 11, 21], 24: [17, 21],
                    25: [3, 8],
                    26: [6, 20], 27: [15, 18], 28: [8, 20, 21, 25, 26, 27], 29: [10, 13, 19, 27], 30: [1, 2, 4, 11],
                    31: [22, 23, 24, 28, 29, 30]}
...
if __name__ == "__main__":
    # node = {1, 3, 4, 6, 12, 13, 16, 17, 18, 21, 22}
    # edge = {(0, 1), (1, 3), (3, 4), (4, 6), (6, 12), (12, 13), (13, 16), (16, 17), (17, 18), (18, 21), (21, 22),
    #         (22, 31)}

    node = {11, 30}
    edge = {(0, 11), (11, 30), (30, 31)}
