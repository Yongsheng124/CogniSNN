...
if __name__ == '__main__':
    ...
    mnist_train = datasets.MNIST(root='E:\\datasets\\MNIST', train=True, download=False, transform=transform)
    mnist_test = datasets.MNIST(root='E:\\datasets\\MNIST', train=False, download=False, transform=transform)
    ...
    for epoch in range(1000):
        ...
        print(model.conv[-1].node.threshold.max(), model.conv[-1].node.threshold.mean(),
              model.conv[-1].node.threshold.min())
